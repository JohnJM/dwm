...
static const int vertpad           = 0; /* vertical margin of bar */
static const int sidepad           = 0; /* horizontal margin of bar */
static const int horizpadbar       = 10; /* horizontal padding for statusbar */
static const int vertpadbar        = 12;  /* vertical padding for statusbar */
static const int monoclemode       = 2; /* automatically switch to tiled mode after opening 2 windows */

static const char *fonts[]    = { "monospace:size=14","NotoColorEmoji:pixelsize=19:antialias=true:autohint=true"};
...
static const Layout layouts[] = {
    ...
    { "[检查]]",   monocle }, /* first entry is default */
    { "[]=",      tile }, 
